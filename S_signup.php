...
if ($password != $cpassword) {
    ...
    $sql= "INSERT INTO student(SAP_ID,`First Name`,`Last Name`,Division,Specialization,Batch,Course,Semester,Password)
    VALUES ('$sapid','$fname','$lname','$Div','$spec','$batch','$course','$semester','$password')";
